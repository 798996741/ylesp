						...
						<div id="table_report" class="table table-striped table-bordered table-hover new-wkj" >
							...
							<div class="new-tk-body-one">
								<div class="new-tk-body-one-wk">
									...
									<div class="one-wk-r"><input type="text" name="NAME" id="NAME" value="${pd.NAME}" maxlength="50" placeholder="这里输入名称" title="名称" /></div>
								</div>
								<span> </span>
							</div>
							...
							<div class="new-tk-body-one">
								<div class="new-tk-body-one-wk">
									...
									<div class="one-wk-r"><input type="text" name="NAME_EN" id="NAME_EN" value="${pd.NAME_EN}" maxlength="50" placeholder="这里输入英文" title="英文" /></div>
								</div>
								<span> </span>
							</div>
							...
							<div class="new-tk-body-one">
								<div class="new-tk-body-one-wk">
									...
									<div class="one-wk-r"><input type="text" name="BIANMA" id="BIANMA" value="${pd.BIANMA}" maxlength="32" placeholder="这里输入编码 (不重复, 禁止修改)" title="编码"  <c:if test="${null != pd.BIANMA}">readonly="readonly"</c:if> <c:if test="${null == pd.BIANMA}">onblur="hasBianma();"</c:if> /></div>
								</div>
								<span> </span>
							</div>
							...
							<div class="new-tk-body-one">
								<div class="new-tk-body-one-wk">
									...
									<div class="one-wk-r"><input type="number" name="ORDER_BY" id="ORDER_BY" value="${pd.ORDER_BY}" maxlength="32" placeholder="这里输入排序" title="排序"/></div>
								</div>
								<span> </span>
							</div>
							...
							<div class="new-tk-body-one">
								<div class="new-tk-body-one-wk">
									...
									<div class="one-wk-r"><input type="text" name="BZ" id="BZ" placeholder="这里输入备注" title="备注"  value="${pd.BZ}"></div>
								</div>
								<span> </span>
							</div>
							...
							<div class="new-tk-body-one">
								<div class="new-tk-body-one-wk">
									...
									<div class="one-wk-r"><input type="text" name="TBSNAME" id="TBSNAME" value="${pd.TBSNAME}" maxlength="100" placeholder="这里输入表名, 多个用逗号分隔(非必录)" title="排查表" /></div>
								</div>
								<span> </span>
							</div>
