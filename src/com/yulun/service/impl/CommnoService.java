...
public class CommnoService implements CommnoManager{
    ...
    @Override
    public PageData findCommonByid(PageData pd) throws Exception {
        return (PageData) dao.findForObject("CommonMapper.findCommonByid",pd);
    }
    ...
    public void deleteCommon(PageData pd) throws Exception {
        dao.delete("CommonMapper.deleteCommon",pd);
    }
