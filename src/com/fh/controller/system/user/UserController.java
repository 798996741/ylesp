...
public class UserController extends BaseController {
	...
	public void deleteU(PrintWriter out) throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		PageData pd_zxyh =zxlbService.findByUsername(pd);
		if(pd_zxyh==null){
	...
	public ModelAndView goAddU()throws Exception{
		...
		/*for(PageData pd_zxz:zxzList){
			if(pd.getString("ZXZ")!=null&&pd.getString("ZXZ").indexOf(pd_zxz.getString("ID"))>=0){
	...
	public ModelAndView goEditMyU() throws Exception{
		...
		mv.addObject("zxzList", zxzList);
		mv.setViewName("system/user/user_pwd");
		mv.addObject("msg", "editU");
		mv.addObject("pd", pd);
		mv.addObject("roleList", roleList);
		return mv;
