...
public class DataAnalyzeService implements DataAnalyzeManager {
    ...
    @Override
    public List<PageData> ConsultTitle(PageData pd) throws Exception {
        return (List<PageData>)dao.findForList("DataAnalyzeMapper.ConsultTitle", pd);
    }

    @Override
    public List<PageData> ConsultlistPage(Page pd) throws Exception {
        return (List<PageData>)dao.findForList("DataAnalyzeMapper.ConsultlistPage", pd);
    }

    @Override
    public PageData ServiceResult(PageData pd) throws Exception {
        return (PageData)dao.findForObject("DataAnalyzeMapper.ServiceResult", pd);
    }
