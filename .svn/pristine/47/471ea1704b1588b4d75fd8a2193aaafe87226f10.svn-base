 ...
 * 云SMS  长泰短信发送
 */
public class CtSmsUtils {

	private static String apId="yulun";
	private static String secretKey="Ctrs@2020";
	//集团名称
	private static String ecName = "长泰县劳动就业中心";
	//网关签名编码
	private static String sign = "gkcycz5vH";	
	//拓展码 填空
