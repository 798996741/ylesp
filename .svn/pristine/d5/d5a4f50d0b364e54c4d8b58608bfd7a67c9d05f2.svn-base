...
public class TrainrecoService implements TrainrecoManager {
    ...
    @Override
    public void saveTrainreco(PageData pd) throws Exception {
        dao.save("TespTrainrecoMapper.saveTrainreco", pd);
    }
    ...
    @Override
    public List<PageData> findjobcaselist(PageData pd) throws Exception {
        return (List<PageData>) dao.findForList("TespTrainrecoMapper.findjobcaselist",pd);
    }
    ...
    @Override
    public List<PageData> TrainZC(PageData pd) throws Exception {
        return (List<PageData>)dao.findForList("TespTrainrecoMapper.TrainZC", pd);
    }
