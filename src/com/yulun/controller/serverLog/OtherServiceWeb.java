...
/**
 * @Author Aliar
 * @Time 2020-05-18 16:44
 **/
public class OtherServiceWeb implements CommonIntefate {
...
//            查询条件
                ...
                List<PageData> list = otherServiceService.findAlllistPage(page);
                if(list.size() > 0){
            ...
            if("otherServiceCustomer".equals(cmd)){
                pd.putAll(json);
            ...
            if("detail".equals(cmd)) {
                ...
                if(pageSize == null || "".equals(pageSize) || pageIndex == null || "".equals(pageIndex) || uid == null || "".equals(uid) ){
                    object.put(SUCCESS,FALSE);
                    object.put(MSG,"入参错误");
                    return object;
                }else {
