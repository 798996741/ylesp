...
<script type="text/javascript">
	function loadWork(){
		...
		var data="{\"api\":\"com.yulun.WorkorderWeb\",\"data\":{\"tokenid\":\"3d0fd800244f48fd9d648724c099528\",\"code\":\"\",\"starttime\":\"\",\"endtime\":\"\",\"tsman\":\"\",\"tssource\":\"\",\"tsdept\":\"\",\"tstype\":\"\",\"pageIndex\":\"1\",\"pageSize\":\"10\",\"doaction\":\"0\",\"username\":\""+userid+"\",\"proc_id\":\""+proc_id+"\"},\"cmd\":\"WorkorderFindById\"}";
   		//alert(data);
		$.ajax({
           	type: 'post',
			url:"<%=path%>/api",
