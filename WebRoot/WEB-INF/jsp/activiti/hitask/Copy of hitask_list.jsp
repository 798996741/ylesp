		...
		<section class="container-fluid">
			...
			<div class="seat-middle-top">
				<div class="seat-middle-top-left">
					...
					<div class="seat-middle-top-left-tp" style="width:1000px">
							...
							<div>
		                    	...
		                    	<select id="tsdepts" name="tsdepts"  >
									...
									<c:forEach items="${tsdeptList}" var="var" varStatus="vs">
										<option value="${var.DICTIONARIES_ID }" <c:if test="${pd.tsdept==var.DICTIONARIES_ID}">selected</c:if>>${var.NAME }</option>
									</c:forEach>
								</select>
								工单状态:
								...
								投诉类别：&nbsp;<input type="text" name="tstypes_name"
									onclick="showMenus();return false" id="tstypes_name" value="${pd.tstypes_name}"
									value="${pd.tstypesname}" maxlength="30" placeholder="选择" readonly />
								<div id="menuContents" class="menuContent" style="position: absolute;display:none;z-index:9999;left:655px">
										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
														...
														<a class="cy_bj" title="流程信息" onclick="view('${var.PROC_INST_ID_}','${var.DEPLOYMENT_ID_ }','${var.DGRM_RESOURCE_NAME_}');">
															<i title="流程信息"></i>
														</a>
												</div>
