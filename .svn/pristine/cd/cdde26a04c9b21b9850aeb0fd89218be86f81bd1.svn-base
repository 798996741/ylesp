...
public class MsgTempService implements MsgTempManager {
    ...
    */
    ...
    @Override
    public List<PageData> getcate(PageData pd) throws Exception {
        return (List<PageData>) dao.findForList("MessageMapper.getcate",pd);
    }

    @Override
    public List<PageData> getcompany(PageData pd) throws Exception {
        return (List<PageData>) dao.findForList("MessageMapper.getcompany",pd);
    }

    @Override
    public void insertMsgId(PageData pd) throws Exception {
        dao.save("MessageMapper.insertMsgId",pd);
    }

    @Override
    public void updateMsgId(PageData pd) throws Exception {
        dao.update("MessageMapper.updateMsgId",pd);
    }

    @Override
    public List<PageData> findSendMsgId(PageData pd) throws Exception {
        return (List<PageData>) dao.findForList("MessageMapper.findSendMsgId",pd);
    }
}
