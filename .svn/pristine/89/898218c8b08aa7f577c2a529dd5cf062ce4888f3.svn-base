...
public class UserService implements UserManager{
	...
	public PageData getUserInfoByUsername(PageData pd)throws Exception{
	...
	public List<PageData> getUserByRoleName(PageData pd) throws Exception{
		return (List<PageData>) dao.findForList("UserMapper.getUserByRoleName", pd);
	}
}
