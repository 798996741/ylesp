...
public class JobReferService implements JobReferManager {
    ...
    public List<PageData> getjob(PageData pd) throws Exception {
        return (List<PageData>)dao.findForList("JobReferMapper.getjob", pd);
    }
    ...
    @Override
    public Integer deleteperson(PageData pd) throws Exception {
         Integer delete = (Integer)dao.delete("JobReferMapper.deleteperson", pd);
        return delete;
    }
    ...
    @Override
    public List<PageData> jobreferDatalistPage(Page pd) throws Exception {
        return (List<PageData>)dao.findForList("JobReferMapper.jobreferDatalistPage", pd);
    }

    @Override
    public List<PageData> personreferDatalistPage(Page pd) throws Exception {
        return (List<PageData>)dao.findForList("JobReferMapper.personreferDatalistPage", pd);
    }

    @Override
    public List<PageData> findEmpMatching(PageData pd) throws Exception {
        return (List<PageData>)dao.findForList("JobReferMapper.findEmpMatching", pd);
    }

    @Override
    public List<PageData> findJobMatching(PageData pd) throws Exception {
        return (List<PageData>)dao.findForList("JobReferMapper.findJobMatching", pd);
    }

    @Override
    public List<PageData> Personrefer(PageData pd) throws Exception {
        return (List<PageData>)dao.findForList("JobReferMapper.Personrefer", pd);
    }

    @Override
    public List<PageData> Companyrefer(PageData pd) throws Exception {
        return (List<PageData>)dao.findForList("JobReferMapper.Companyrefer", pd);
    }
