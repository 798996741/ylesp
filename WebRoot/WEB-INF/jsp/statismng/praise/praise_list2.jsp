...
<body class="no-skin">
	...
	<script type="text/javascript">
		...
		function searchmon(mon) {
			...
			if (mon=='1'){
				//本周
				location.href="<%=path%>/complain/bytypedata.do?starttime="+getWeekStartDate()+
						"&endtime="+getWeekEndDate()+"&tsdept="+tsdepts;
			}else if (mon=='2'){
				//本月
				location.href="<%=path%>/complain/bytypedata.do?starttime="+getMonthStartDate()+
						"&endtime="+getMonthEndDate()+"&tsdept="+tsdepts;
			}else if (mon=='3'){
				//本季
				location.href="<%=path%>/complain/bytypedata.do?starttime="+getQuarterStartDate()+
						"&endtime="+getQuarterEndDate()+"&tsdept="+tsdepts;
			}else if (mon=='4'){
				//本年
				location.href="<%=path%>/complain/bytypedata.do?starttime="+getYearStartDate()+
