...
public class NaireService implements NaireManager{
	...
	@SuppressWarnings("unchecked")
	public List<PageData> listStartAndEndConde(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("NaireMapper.listStartAndEndConde", pd);
	}
	 ...
	 * @throws Exception
	 */
	public PageData findByNextId(PageData pd)throws Exception{
		return (PageData)dao.findForObject("NaireMapper.findByNextId", pd);
	}
