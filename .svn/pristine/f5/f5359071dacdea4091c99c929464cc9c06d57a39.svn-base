						...
						<div id="table_report" class="table table-striped table-bordered table-hover new-wkj">
							...
							<div class="new-tk-body-one">
								<div class="new-tk-body-one-wk">
									...
									<div class="one-wk-r"><input type="text" name="ZMC" id="ZMC" value="${pd.ZMC}" maxlength="255" placeholder="这里输入分组名称" title="分组名称" /></div>
								</div>
								<span> </span>
							</div>
							...
							<div class="new-tk-body-one">
								<div class="new-tk-body-one-wk">
									...
									<div class="one-wk-r"><input type="text" name="ZBH" id="ZBH" value="${pd.ZBH}" maxlength="255" placeholder="这里输入分组编码" title="分组编码" /></div>
								</div>
								<span> </span>
							</div>
							...
							<div class="new-tk-body-one">
								<div class="new-tk-body-one-wk">
									...
									<div class="one-wk-r"><input type="text" name="GLR" id="GLR" value="${pd.GLR}" maxlength="255" placeholder="这里输入组长" title="组长" /></div>
								</div>
								<span> </span>
							</div>
							...
							<div class="new-tk-body-one">
								<div class="new-tk-body-one-wk">
									...
									<div class="one-wk-r"><input type="text" name="BZ" id="BZ" value="${pd.BZ}" maxlength="255" placeholder="这里输入备注" title="备注" /></div>
								</div>
								<span> </span>
							</div>
							...
							<div class="new-left " style="width:100%">
								...
								<div class="new-table-nr" style="width:100%">
									...
									<c:forEach items="${dictList}" var="var" varStatus="vs">
											<input style="vertical-align: middle;" name="ZJNCHECK"  value="${var.DICTIONARIES_ID}" ${var.checked} type="checkbox" id="ZJNCHECK">&nbsp;&nbsp;${var.NAME}
