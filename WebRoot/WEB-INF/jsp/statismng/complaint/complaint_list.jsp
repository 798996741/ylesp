...
<body class="no-skin">
	...
	<script type="text/javascript">
		...
		function search() {
			var starttime=$("#starttime").val();
			var endtime=$("#endtime").val();
			location.href="<%=path%>/complain/golist.do?starttime="+starttime+
					"&endtime="+endtime;
		}
		...
		function searchmon(mon) {
			...
			if (mon=='1'){
				//本周
				location.href="<%=path%>/complain/golist.do?starttime="+getWeekStartDate()+
						"&endtime="+getWeekEndDate();
			}else if (mon=='2'){
				//本月
				location.href="<%=path%>/complain/golist.do?starttime="+getMonthStartDate()+
						"&endtime="+getMonthEndDate();
			}else if (mon=='3'){
				//本季
				location.href="<%=path%>/complain/golist.do?starttime="+getQuarterStartDate()+
						"&endtime="+getQuarterEndDate();
			}else if (mon=='4'){
				//本年
				location.href="<%=path%>/complain/golist.do?starttime="+getYearStartDate()+
