...
<body class="no-skin">
		...
		<section class="container-fluid">
			...
			<div class="seat-middle-top">
				<div class="seat-middle-top-left">
					<div class="seat-middle-top-left-bt">建议统计</div>
	...
	<script type="text/javascript">
		...
		function search() {
			var starttime=$("#starttime").val();
			var endtime=$("#endtime").val();
			location.href="<%=path%>/complain/goadviselist.do?starttime="+starttime+
					"&endtime="+endtime;
		}
		function searchmon(mon) {
			if (mon=='1'){
				//本周
				location.href="<%=path%>/complain/goadviselist.do?starttime="+getWeekStartDate()+
						"&endtime="+getWeekEndDate();
			}else if (mon=='2'){
				//本月
				location.href="<%=path%>/complain/goadviselist.do?starttime="+getMonthStartDate()+
						"&endtime="+getMonthEndDate();
			}else if (mon=='3'){
				//本季
				location.href="<%=path%>/complain/goadviselist.do?starttime="+getQuarterStartDate()+
						"&endtime="+getQuarterEndDate();
			}else if (mon=='4'){
				//本年
				location.href="<%=path%>/complain/goadviselist.do?starttime="+getYearStartDate()+
