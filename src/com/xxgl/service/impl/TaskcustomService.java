...
public class TaskcustomService implements TaskcustomManager{
	...
	public void saveHF(PageData pd)throws Exception{
		dao.update("TaskcustomMapper.saveHF", pd);
	}
	 ...
	 * @throws Exception
	 */
	public PageData findByTaskIdAndCusId(PageData pd)throws Exception{
		return (PageData)dao.findForObject("TaskcustomMapper.findByTaskIdAndCusId", pd);
	}
