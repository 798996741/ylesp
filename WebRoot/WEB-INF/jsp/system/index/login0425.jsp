...
<div class="index-middle">
    <form action="" method="post" name="loginForm" id="loginForm" style="height: 88%;width: 100%;">
        <div class="drjm">
            <div class="drjm-logo">
                <img src="static/login/images/indx-logo.png">
            </div>
            <div class="username">
            ...
            <div class="username">
                ...
                <div class="user">
                    <input placeholder="请输入验证码" value="6666" name="code" id="code">
            ...
            <div class="dr"><a onclick="severCheck();" id="to-recover">登录</a></div>
        </div>
    </form>
</div>
<%-- </div>
