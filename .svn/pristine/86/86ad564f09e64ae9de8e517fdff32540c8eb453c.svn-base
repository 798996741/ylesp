			...
			<c:if test="${empty pd.doaction}">
				<%if(jurisdiction.hasQx("70209")){ %>
					<div class="seat-middle-top" style="height:120px;line-height:25px;">
						<div class="seat-middle-top-left" style="height:120px;">
							<div class="seat-middle-top-left-tp" style="margin-top:10px;pheight:120px;" >
								
									<form action="workorder/editFile.do" name="Form" id="Form_upload" method="post" enctype="multipart/form-data">
										<div>	
											<table style="width:700px;">
												<tr>
													<td style="width:20%;text-align:right;height:35px">请输入附件名称：</td>
													<td>
														<input type="hidden" name="uid" id="uid" value="${pd.uid}">
														<input type="text" name="filenames" id="filenames">
													</td>
												</tr>	
												<tr>
												...
												<tr>
													<td colspan="2" style="text-align:center">
														<div class="new-bc">
															<a onclick="saveFile();" style="width:120px;padding:0px;padding-left:30px">上传此附件</a> 
															<a class="new-qxbut" type="button" style="width:90px;padding:0px;padding-left:30px"  onclick="parent.closeFileLayer();" >取消</a>
														</div>
													</td>
												</tr>
											</table>
												...
												<div>
													<c:choose> 
														<c:when test="${var.ext=='png'||var.ext=='PNG'||var.ext=='gif'||var.ext=='GIF'||var.ext=='jpg'||var.ext=='JPG'||var.ext=='JPEG'||var.ext=='jpeg'}">
															<a title="查看" onclick="imgShow('<%=path %>/uploadFiles/uploadFile/${var.file}')">
																查看
															</a>
															&nbsp;
															<a title="下载" href="<%=path %>/workorder/downLoadFile.do?id=${var.id}">
																下载
															</a>
														</c:when>
														<c:otherwise>&nbsp;
