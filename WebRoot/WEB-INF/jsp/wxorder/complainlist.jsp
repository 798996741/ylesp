...
<script type="text/javascript">
	function loadWork(){
		...
		var data="{\"api\":\"com.yulun.WorkorderWeb\",\"data\":{\"tokenid\":\"3d0fd800244f48fd9d648724c099528\",\"code\":\"\",\"starttime\":\"\",\"endtime\":\"\",\"tsman\":\"\",\"tssource\":\"\",\"tsdept\":\"\",\"tstype\":\"\",\"pageIndex\":\"1\",\"pageSize\":\"10\",\"doaction\":\"0\",\"username\":\""+userid+"\",\"keywords\":\""+keywords+"\"},\"cmd\":\"WorkorderAll\"}";
   		//alert(data);
		$.ajax({
           	type: 'post',
	...
	function cl(id,cfbm){
		...
		var id='${pd.id}';
		if(action!=""){
			location.href="<%=path%>/appWeixin/complandetail_sh?ID_="+ID_+"&proc_id="+proc_id+"&cfbm="+cfbm+"&userid="+userid;
		}else{
			location.href="<%=path%>/appWeixin/complandetail_sh?action=1&id="+id+"&userid="+userid;
